...
| [Hugging Face](https://huggingface.co/docs/api-inference/) | Free inference API for thousands of pre-trained AI models including NLP, computer vision, and audio | `apiKey` | Yes | Unknown |
