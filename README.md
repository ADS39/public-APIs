...
| [GoCardless (Nordigen)](https://developer.gocardless.com/bank-account-data/quick-start-guide) | Connect to bank accounts using official bank APIs and get raw transaction data | `OAuth` | Yes | Unknown | |
